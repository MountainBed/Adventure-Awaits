...
CREATE TABLE `page_table` (
  ...
  `page_text` VARCHAR(2000) NOT NULL,
  `page_choice1` VARCHAR(45) NOT NULL,
  `page_choice2` VARCHAR(45) NULL,
  `page_choice3` VARCHAR(45) NULL,
  `page_status` TINYINT NOT NULL DEFAULT 1,
  `page_date` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `page_update` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
